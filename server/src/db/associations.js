const { Agent, Client, Order, Manager, Contractor, Subagent, SubagentPayer, Country, File } = require('./entities/enteties');
...
const associateModels = () => {
  ...
  Manager.belongsToMany(Order, { through: 'OrderReviewers', as: 'review_table', onDelete: 'CASCADE' });
