...
import RenderData from "../../shared/components/RenderData"
import columnsConfig from "../../shared/lib/tableColumnsData/index"
import titleMappings from "../../shared/lib/tableTitles"
...
export const RelatedDataModal: React.FC<RelatedDataModalProps> = ({isOpen, relatedName, relatedKey, cellItem, setTitle, setSelectedCell}) => {
