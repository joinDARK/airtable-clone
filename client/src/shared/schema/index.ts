...
const OrderSchema: ZodType = z.lazy(() =>
  z.object({
    ...
    reviewers: z.array(ManagerSchema),
    date: z.string().date(),
    date_hired: z.string().date().optional(),
    contragent: z.array(ContragentSchema),
    agents: z.array(AgentSchema),
    clients: z.array(ClientSchema),
    client_inn: z.string().optional(),
    name_agency: z.string().min(1),
    ...
    subagentsPayers: z.array(SubagentPayerSchema),
