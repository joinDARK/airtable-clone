...
function CellModal({ data, submit, type = "text", invalidateTable }: Props) {
  ...
  return (
    <div>
      ...
      >
        {isEdit ? (
          <EditCellModal value={data} submit={submit} type={type} />
        ) : (
          <ViewCellModal value={data} type={type} invalidateTable={invalidateTable} />
        )}
      </div>
    </div>
  );
