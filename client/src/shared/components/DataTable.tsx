...
export const DataTable: React.FC<DataTableProps> = ({
  ...
  return (
    <div className='flex flex-col h-full transition-all duration-300'>
        ...
        <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4'>
          <div className='flex flex-col sm:flex-row sm:items-center gap-3'>
            <div className='flex items-center gap-3'>
              ...
              <button onClick={onRefresh} className='p-2 hover:bg-gray-100 rounded-lg transition-colors dark:hover:bg-gray-600' title='Refresh'>
      ...
      <Modal isOpen={isModalViewOpen ? true : false} onClose={() => closeModal()} title={newTitle}>
        <RelatedDataModal isOpen={isModalViewOpen} cellItem={item} relatedKey={item.id} relatedName={relatedName} setTitle={setNewTitle} />
      </Modal>
    </div>
  )
}
