...
export const statusOptions = [
  ...
  { value: "Cогласован получатель (только для Экспорта)", label: "Cогласован получатель (только для Экспорта)", style: 'bg-lime-100 text-lime-800 border-lime-200' },
  ...
  { value: "17`. Ждём поступление валюты получателю", label: "17`. Ждём поступление валюты получателю", style: 'bg-pink-100 text-pink-800 border-pink-200' },
